  ...
  return (
    <footer className="fixed bottom-0 w-full">
      <div className="bg-gray-600">
        <div className="m-auto flex flex-wrap justify-between border-t px-3 text-sm">
          <div className="py-1 text-white">
            © Copyright {year}. All Rights Reserved.
          </div>
          <div className="flex h-7 flex-row py-1 md:flex-auto md:flex-row-reverse">
            <a href="/#" className="mx-1 w-6">
              <svg
                className="cursor-pointer fill-current text-gray-100 hover:text-gray-400"
                width="100%"
                height="100%"
                viewBox="0 0 24 24"
                version="1.1"
